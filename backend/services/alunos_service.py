...
def historico_aluno_service(aluno_id: int) -> dict:
    ...
    for t in triagens_raw:
        ...
        triagens.append({'id': t.id, 'data': data, 'tipo': t.tipo_registro,
            ...
            'queixa_principal': t.queixa_principal, 'descricao': t.descricao,
            'evolucao': t.evolucao, 'observacoes': t.observacoes,
            'avaliacoes_json': t.avaliacoes_json, 'profissional': psico})
